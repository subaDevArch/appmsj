  ...
  return (
    <div className="m-4">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.</p>
      </div>
      <hr className="my-4" />
      <div className="my-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">Noticias Preceptoria</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {/* Aquí puedes colocar los elementos destacados */}
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2">Destacado 1</h3>
